...
<p align="center">
<a href="#"><img title="Version" src="https://img.shields.io/badge/Version-1.5-green.svg?"></a>
...
<a href="https://github.com/Phantom-19/crypfun/stargazers/"><img title="Étoiles" src="https://img.shields.io/github/stars/Phantom-19/crypfun??color=red"></a>
<a href="https://github.com/Phantom-19/crypfun/network/members"><img title="Fourches" src="https://img.shields.io/github/forks/Phantom-19/crypfun??color=red"></a>
<a href="https://github.com/Phantom-19/crypfun/watchers"><img title="En train de regarder" src="https://img.shields.io/github/watchers/Phantom-19/crypfun?label=Watchers&color=blue"></a>
<p align="right">
<a href="#"><img title="Langage" src="https://forthebadge.com/images/badges/made-with-python.svg"></a>
</p>

## `Installation crypfun `:

* `apt update`
* `apt install git  python `
* `git clone https://github.com/Phantom-19/crypfun.git`
* `cd Hacker`
## ` Execution > ` `python3 crypte.py`

## ` NOM D'UTILISATEUR : Faxel    `
## ` MOT DE PASSE      : 08127934 `

##  `Commande unique de crypfun`:
```
apt update ; apt install git curl -y ; git clone https://github.com/Phantom-19/crypfun.git ; cd crypfun ; python3 crypte.py
```
